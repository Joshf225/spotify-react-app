              ...
              {newPlaylist?.map((tracks, length) => {
                ...
                return (
                  <div className="prev-loader" key={tracks.track.id}>
                    ...
                    />
                    <div className="song">
                      <p className="prev-song-name">{tracks.track.name}</p>
                      <p className="prev-artist">
                        {tracks.track.artists?.map((artist, i) => {
                          const len = tracks.track.artists?.length;
                          return `${artist.name}${len === i + 1 ? "." : ", "}`;
                        })}
                      </p>
                    </div>
                    <img
